...
import { VectorLeftIcon, VectorRightIcon, HeartEmptyIcon, HeartIcon } from "@/assets/icons";
...
export default function Play() {
  ...
  const [pos, setPos] = useState({ position: "pt-[30vh]", direction: Boxlion_left });
        ...
        <div className="relative w-full h-full z-10 bg-cover bg-center">
          <div>
            <p className="text-white text-center pt-[50px] text-[40px] font-semibold flex justify-center">
              {health.map((item, index) => <Image key={index} src={item == 1 ? HeartIcon : HeartEmptyIcon} alt="heart"></Image>)}
            </p>
            <h5 className="text-[24px] font-medium">10/<span className="text-[#767676]">1000</span></h5>
          </div>
          <div className={`relative flex justify-center ${pos.position}`}>
            ...
            <div className="relative flex items-center space-x-4">
              <Image src={pos.direction} className="z-[100]" alt="Boxlion Left" />
          ...
          <div className="fixed bottom-0 w-full px-[20px] pb-[20px]">
            <div className="flex justify-around">
              <Button className="w-[70px] h-[70px] bg-[#F39932] rounded-full" onClick={() => changePos("pt-[12vh]", Boxlion_left, 1)}>
                <svg xmlns="http://www.w3.org/2000/svg" width="51" height="52" viewBox="0 0 51 52" fill="none">
                  <path d="M27.5771 20.761C28.1984 20.761 28.7021 20.2573 28.7021 19.636C28.7021 19.0147 28.1984 18.511 27.5771 18.511L19.0918 18.511C18.4705 18.511 17.9668 19.0147 17.9668 19.636L17.9668 28.1213C17.9668 28.7426 18.4705 29.2463 19.0918 29.2463C19.7132 29.2463 20.2168 28.7426 20.2168 28.1213L20.2168 22.352L30.4939 32.6291C30.9333 33.0684 31.6456 33.0684 32.0849 32.6291C32.5243 32.1897 32.5243 31.4774 32.0849 31.0381L21.8078 20.761H27.5771Z" fill="black" />
                </svg>
              </Button>
              <Button className="w-[70px] h-[70px] bg-[#F39932] rounded-full" onClick={() => changePos("pt-[12vh]", Boxlion_right, -1)}>
                <svg xmlns="http://www.w3.org/2000/svg" width="51" height="52" viewBox="0 0 51 52" fill="none">
                  <path d="M23.4229 20.761C22.8016 20.761 22.2979 20.2573 22.2979 19.636C22.2979 19.0147 22.8016 18.511 23.4229 18.511L31.9082 18.511C32.5295 18.511 33.0332 19.0147 33.0332 19.636L33.0332 28.1213C33.0332 28.7426 32.5295 29.2463 31.9082 29.2463C31.2868 29.2463 30.7832 28.7426 30.7832 28.1213L30.7832 22.352L20.5061 32.6291C20.0667 33.0684 19.3544 33.0684 18.9151 32.6291C18.4757 32.1897 18.4757 31.4774 18.9151 31.0381L29.1922 20.761H23.4229Z" fill="black" />
                </svg>
              </Button>
            </div>
            <div className="flex justify-between">
              <Button className="w-[70px] h-[70px] bg-[#F39932] rounded-full" onClick={() => changePos("pt-[30vh]", Boxlion_left, 1)}>
                <svg xmlns="http://www.w3.org/2000/svg" width="51" height="52" viewBox="0 0 51 52" fill="none">
                  <path d="M20.2169 23.8787C20.2169 23.2574 19.7132 22.7537 19.0919 22.7537C18.4706 22.7537 17.9669 23.2574 17.9669 23.8787L17.9669 32.364C17.9669 32.9853 18.4706 33.489 19.0919 33.489L27.5772 33.489C28.1985 33.489 28.7022 32.9853 28.7022 32.364C28.7022 31.7427 28.1985 31.239 27.5772 31.239L21.8079 31.239L32.085 20.9619C32.5243 20.5225 32.5243 19.8102 32.085 19.3709C31.6456 18.9316 30.9333 18.9316 30.494 19.3709L20.2169 29.648V23.8787Z" fill="black" />
                </svg>
              </Button>
              <Button className="w-[70px] h-[70px] bg-[#F39932] rounded-full" onClick={() => changePos("pt-[30vh]", Boxlion_right, -1)}>
                <svg xmlns="http://www.w3.org/2000/svg" width="51" height="52" viewBox="0 0 51 52" fill="none">
                  <path d="M30.7831 23.8787C30.7831 23.2574 31.2867 22.7537 31.9081 22.7537C32.5294 22.7537 33.0331 23.2574 33.0331 23.8787L33.0331 32.364C33.0331 32.9853 32.5294 33.489 31.9081 33.489L23.4228 33.489C22.8015 33.489 22.2978 32.9853 22.2978 32.364C22.2978 31.7427 22.8015 31.239 23.4228 31.239L29.1921 31.239L18.915 20.9619C18.4756 20.5225 18.4756 19.8102 18.915 19.3709C19.3543 18.9316 20.0666 18.9316 20.506 19.3709L30.7831 29.648V23.8787Z" fill="black" />
                </svg>
              </Button>
            </div>
          </div>
