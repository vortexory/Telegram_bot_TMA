    ...
    <div className="relative overflow-y-hidden flex flex-col justify-center items-center">
      <div className="pt-[50px] w-full items-center px-[20px] pb-5 h-screen flex flex-col justify-between bg-black">
        <div className="flex relative flex-col space-y-1">
          <p className="text-white text-base text-opacity-40 font-semibold">
            Daily check-in
          </p>
        ...
        <div className="relative w-[226px] h-[226px]">
          ...
          <div className="absolute left-1/2 top-1/2 p-4 -translate-x-1/2 -translate-y-1/2 z-10 w-[226px] h-[226px]">
            <Image className="w-full h-full" src={ImgKinglion} alt="logo" />
          </div>
        </div>
        <div className="w-full flex flex-col space-y-1">
          <p className="text-[20px] text-white text-opacity-40 font-normal">
            You got:
          </p>
